  ...
  <section class="showcase">
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        ...
        <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('${cp }/resources/img/ca.jpg');"></div>
      ...
      <div class="row no-gutters">
        <div class="col-lg-6 text-white showcase-img" style="background-image: url('${cp }/resources/img/ka.jpg');"></div>
      ...
      <div class="row no-gutters">
        <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('${cp }/resources/img/pi.jpg');"></div>
        <div class="col-lg-6 order-lg-1 my-auto showcase-text">
