...
<!-- mypageNavi -->
<style>
	.nav span{color:#2E9AFE; font-weight: bolder; font-size: 2em;}
	.nav a{font-size: 1.3em; margin-left: 30px; font-weight: bold; }
	a:hover{color:red;}
</style>

	<nav class="nav nav-tabs flex-column col-md-2" style="float: left;  height:1200px; background-color: #FBEFEF; ">
