...
<head>
	...
	<link rel="apple-touch-icon" href="${cp }/resources/images/icon.png">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-2 col-sm-4 col-md-6 order-1 order-lg-1">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="${cp }/resources/images/logo/nm.png" alt="logo images" style="width: 200px;height: 200px;">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row mt--30">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="service">
                                <div class="service__title">
                                    <div class="ser__icon">
                                        <img src="${cp }/resources/images/icon/color-icon/1.png" alt="icon image">
                                    </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="service">
                                <div class="service__title">
                                    <div class="ser__icon">
                                        <img src="${cp }/resources/images/icon/color-icon/2.png" alt="icon image">
                                    </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="service">
                                <div class="service__title">
                                    <div class="ser__icon">
                                        <img src="${cp }/resources/images/icon/color-icon/3.png" alt="icon image">
                                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="food__item foo">
                                <div class="food__thumb">
                                    <a href="menu-details.html">
                                        <img src="${cp }/resources/images/product/md-product/1.jpg" alt="product images">
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="food__item foo">
                                <div class="food__thumb">
                                    <a href="menu-details.html">
                                        <img src="${cp }/resources/images/product/md-product/2.jpg" alt="product images">
                                    </a>
                                </div>
                                <div class="food__title">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="food__item foo">
                                <div class="food__thumb">
                                    <a href="menu-details.html">
                                        <img src="${cp }/resources/images/product/md-product/3.jpg" alt="product images">
                                    </a>
                                </div>
                                <div class="food__title">
                                            ...
                                            <div class="single__tab__content">
                                                ...
                                                <div class="food__menu">
                                                    <div class="food__menu__thumb">
                                                        <a href="menu-details.html">
                                                            <img src="${cp }/resources/images/product/sm-img/1.jpg" alt="product images">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="food__menu">
                                                    <div class="food__menu__thumb">
                                                        <a href="menu-details.html">
                                                            <img src="${cp }/resources/images/product/sm-img/2.jpg" alt="product images">
                                                        </a>
                                                    </div>
                                                    <div class="food__menu__details">
                                                        <div class="fd__menu__title__prize">
                                                ...
                                                <div class="food__menu">
                                                    <div class="food__menu__thumb">
                                                        <a href="menu-details.html">
                                                            <img src="${cp }/resources/images/product/sm-img/3.jpg" alt="product images">
                                                        </a>
                                                    </div>
                                                    <div class="food__menu__details">
                                                        <div class="fd__menu__title__prize">
                                                ...
                                                <div class="food__menu">
                                                    <div class="food__menu__thumb">
                                                        <a href="menu-details.html">
                                                            <img src="${cp }/resources/images/product/sm-img/4.jpg" alt="product images">
                                                        </a>
                                                    </div>
                                                    <div class="food__menu__details">
                                                        <div class="fd__menu__title__prize">
