...
<div>
	...
	<div class="row">
		...
		<h1 class="text-info text-center">나의 문의 목록</h1>
			<button class="btn btn-primary" onclick="location.href='${cp }/pj/bs/bqinsert'" style=" float: right;">문의하기</button>
		    ...
		    <c:forEach var="vo" items="${alllist}">		
				<tbody>
					<tr class="table-danger">
						<td>${ vo.bq_num}</td>
						<td><a href="${cp }/pj/bs/bqcontent?bq_num=${ vo.bq_num}" data-toggle="tooltip" data-original-title="Detail" >${ vo.bq_title}</a></td>
						<c:choose>
